    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="jual" id="jual" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row row-bawah">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Tempo (Bulan)</label>
                        <select name="tempo" id="tempo" class="form-control">
                            <option value="" disabled selected>Pilih Tempo Pembayaran</option>
                            <?php foreach ($tempo->result() as $row) { ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="prosentase" id="prosentase" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
